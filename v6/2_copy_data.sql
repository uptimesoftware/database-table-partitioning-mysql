...
INSERT INTO vsync_update_par SELECT * FROM vsync_update;
RENAME TABLE vsync_update TO vsync_update_ori;
RENAME TABLE vsync_update_par TO vsync_update;
DROP TABLE IF EXISTS vsync_update_ori;
