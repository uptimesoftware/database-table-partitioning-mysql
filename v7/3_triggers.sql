DROP TRIGGER IF EXISTS trig_p_aggregate;
...
DROP TRIGGER IF EXISTS trig_vp_aggregate;
...
DROP TRIGGER IF EXISTS trig_nd_ping;
...
DROP TRIGGER IF EXISTS trig_nd_port;
